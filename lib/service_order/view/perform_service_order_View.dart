  ...
  Widget _buildServiceCard(ServiceOrder service, BuildContext context) {
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            _getCardDetails(service, context, controller);
          },
          borderRadius: BorderRadius.circular(12),
          child: Padding(
            padding: const EdgeInsets.all(16),
...
void _getCardDetails(ServiceOrder service, BuildContext context, ServiceOrderController controller) {
...
List<String> tempImages = [...(service.images ?? [])];
showDialog(
context: context,
...
onPressed: () async {
final imagePickerUseCase =
getIt<ServiceOrderController>().imagePickerUseCase;
...
onPressed: () async {
final controller = getIt<ServiceOrderController>();
...
await controller.update(service.id!, updatedOrder);
...
// Método auxiliar para renderizar as imagens

                                ...
                                return Container(
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: MemoryImage(
                                        base64Decode(service.images![index]),
                                      ),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                            ...
                            children: [
                              Expanded(
                                child: OutlinedButton.icon(
                                  onPressed: () async {
                                    final image = await context.read<ServiceOrderController>()
                                        .imagePickerUseCase.pickFromGallery();
                                    if (image != null && service.id != null) {
                                      await context.read<ServiceOrderController>()
                                          .addImageToServiceOrder(service.id!, image);
                                      setState(() {});
                                    }
                                  },
